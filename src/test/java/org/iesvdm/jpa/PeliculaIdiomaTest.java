...
@SpringBootTest
public class PeliculaIdiomaTest {
    ...
    void grabarMultiplesPeliculasIdioma() {
        ...
        Idioma idioma1 = new Idioma(0, "español", new ArrayList<>());
        idiomaRepository.save(idioma1);

        Pelicula pelicula1=new Pelicula(0,"Pelicula",new HashSet<>(),idioma1,null);
        idioma1.getPeliculas().add(pelicula1);
        peliculaRepository.save(pelicula1);

        Pelicula pelicula2 = new Pelicula(0,"Pelicula2",new HashSet<>(),idioma1,null);
        idioma1.getPeliculas().add(pelicula2);
        peliculaRepository.save(pelicula2);

        Idioma idioma2 = new Idioma(0, "inglés", new ArrayList<>());
        idiomaRepository.save(idioma2);

        Pelicula pelicula3 = new Pelicula(0,"Pelicula3",new HashSet<>(),idioma2,null);
